Pod::Spec.new do |spec|
  spec.name          = 'AnimaJokesSketchUIKit'
  spec.version       = '1.0'
  spec.license       = { :type => 'MIT' }
  spec.homepage      = 'http://www.animaapp.com'
  spec.authors       = { 'alexeyweb11@gmail.com' => '' }
  spec.summary       = 'AnimaJokesSketch UI Kit'
  spec.source        = { :git => '' }
  spec.source_files  = 'AnimaJokesSketchUIKit/*.{h,m,swift}'
  ...
  spec.resources     = ['AnimaJokesSketchUIKit/**/*.{xcassets,storyboard}', 'AnimaJokesSketchUIKit/Resources/**/*.*']
